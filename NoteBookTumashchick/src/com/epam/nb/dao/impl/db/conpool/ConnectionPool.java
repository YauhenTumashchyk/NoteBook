...
public class ConnectionPool { // Singleton
	...
	private ConnectionPool() { // singleton
		...
		try {
			poolsize = Integer.parseInt(dbResourceManager
	...
	public void initPoolData() throws ConnectionPoolException {
		...
		try {
			...
			throw new ConnectionPoolException(
					"Can't find database driver slass", e);
		}
	}
	...
	public void clearConnectionQueue() {
		try {
			...
			log.error("Error closing the connention.", e);
		}
	}
	...
	public Connection takeConnection() throws ConnectionPoolException {
		...
		try {
			...
			throw new ConnectionPoolException(
					"Error conection to the data source.", e);
		}
		return connection;
	}
	...
	private class PooledConnection implements Connection {
		...
		public void close() throws SQLException {
			if (connection.isClosed()) {
				throw new SQLException("Attempting to closed connection.");
			}
			...
			if (!connectionQueue.offer(this)) {
				throw new SQLException(
						"Error allocation connection in the pool.");
			}
		}
